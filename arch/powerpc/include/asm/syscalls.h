...
asmlinkage long compat_sys_ppc_pread64(unsigned int fd, char __user *ubuf,
				       compat_size_t count,
				       u32 reg6, u32 pos1, u32 pos2);

asmlinkage long compat_sys_ppc_pwrite64(unsigned int fd, const char __user *ubuf,
					compat_size_t count,
					u32 reg6, u32 pos1, u32 pos2);

asmlinkage long compat_sys_ppc_readahead(int fd, u32 r4, u32 offset1,
					 u32 offset2, u32 count);

asmlinkage long compat_sys_ppc_truncate64(const char __user *path, u32 reg4,
					  unsigned long len1, unsigned long len2);

asmlinkage long compat_sys_ppc_fallocate(int fd, int mode, u32 offset1,
